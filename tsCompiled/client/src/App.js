...
const ProjectsPage_1 = __importDefault(
  require('./pages/Projects/ProjectsPage')
);
const Sidebar_1 = __importDefault(require('./components/Sidebar'));
require('./styles.css');
const DashboardPage_1 = __importDefault(
...
const SettingsPage_1 = __importDefault(
  require('./pages/Settings/SettingsPage')
);
const App = () => {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(react_router_1.Route, {
        path: '/projects',
        element: react_1.default.createElement(ProjectsPage_1.default, null),
      })
    ),
    react_1.default.createElement(
      'button',
